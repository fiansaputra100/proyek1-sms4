...
if (isset($_POST["register"]))
{
  ...
  $ambil = $koneksi->query("SELECT*FROM admin_1 WHERE username ='$username'");
...
else
{
 ...
 $koneksi->query("INSERT INTO admin_1 (username,nama,password,email,telepon) 
  VALUES('$username','$nama,'$password','$email','$telepon','$alamat')");
