...
$semuadata=array();
$ambil = $koneksi->query("SELECT * FROM wisata WHERE nama_wisata LIKE '%$keyword%'");
...
<div class="container-xxl py-4">
        <div class="container">
            <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
                <h1 class="mb-5">Pencarian : <?php echo $keyword ?></h1>
            </div>
                ...
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="package-item d-grid" style="width: 1100px">
                        ...
                        <div class="p-3 d-grid">
                            <br>
                            <h3 class="mb-9" text-color:red><?php echo $value["nama_wisata"] ?></h3>
                            <h3 class="mb-0">Rp. <?php echo $value["harga_wisata"] ?></h3>
                            <p><?php echo $value['lokasi_wisata']; ?></p>
