...
>
  ...
  <body>
    <!-- Layout wrapper -->
    <div class="layout-wrapper layout-content-navbar " style="display:flex; justify-content:relative;" >
      <div class="layout-container" style="display:flex; justify-content:left;">
        <!-- Menu -->
          ...
          <ul class="menu-inner py-1">
            ...
            <li class="menu-item">
              <a href="javascript:void(0);" class="menu-link menu-toggle">
                ...
                <div data-i18n="Account Settings">Destinasi</div>
              </a>
              <ul class="menu-sub">
                <li class="menu-item">
                  <a href="index.php?halaman=wisata" class="menu-link">
                    <div data-i18n="Account">Tempat Wisata</div>
                  </a>
                </li>
                <li class="menu-item">
                  <a href="index.php?halaman=informasi_wisata" class="menu-link">
                    <div data-i18n="Notifications">Informasi Wisata</div>
                  </a>
                </li>
              </ul>
            </li>
            ...
            <!-- Forms & Tables -->
            <li class="menu-header small text-uppercase"><span class="menu-header-text">Data Pelanggan</span></li>
            <!-- Forms -->
            <li class="menu-item">
              <a href="javascript:void(0);" class="menu-link menu-toggle">
              ...
              <ul class="menu-sub">
                <li class="menu-item">
                  <a href="index.php?halaman=laporan_pembelian" class="menu-link">
                    <div data-i18n="Accordion">Laporan Pembelian</div>
                  </a>
                </li>
                <li class="menu-item">
                  <a href="index.php?halaman=transaksi" class="menu-link">
            ...
            <!-- Forms & Tables -->
            <li class="menu-header small text-uppercase"><span class="menu-header-text">Manajemen Akun</span></li>
            <!-- Forms -->
            <li class="menu-item">
              <a href="javascript:void(0);" class="menu-link menu-toggle">
                <i class="menu-icon tf-icons bx bx-user"></i>
                <div data-i18n="Form Elements">Profile Akun</div>
              </a>
              <ul class="menu-sub">
                <li class="menu-item">
                  <a href="index.php?halaman=admin" class="menu-link">
                    <div data-i18n="Accordion">Akun Admin</div>
                  </a>
                </li>
                <li class="menu-item">
                  <a href="index.php?halaman=pelanggan" class="menu-link">
                    <div data-i18n="Alerts">Akun Pelanggan</div>
                  </a>
                </li>
...
<section class="konten">
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-3">
                <div class="thumbnail">
                <?"<img src='..admin/php/foto_wisata/".$perwisata['foto_wisata']."'style='width:1100px; height:300px; float:right; margin:5px;'>"?>
            <div class="caption">
                <h3>Jaket</h3>
                <h5>Rp. 100.000</h5>
